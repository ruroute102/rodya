...
Текущий `model.glb` сгенерирован скриптом `tools/generate_audi_q3_glb.py`.
Это app-ready v1: отдельные узлы, правильные пропорции Q3 8U, x-ray кузов,
зона топливного насоса и именование mesh/node для управления из приложения.
